...
const Navbar = () => {
  ...
  return (
    <div className="h-12 md:h-24 border-b-orange-500 border-b-2 p-4 lg:px-20 xl:px-40 flex justify-between items-center text-orange-400 sticky top-0 z-30 bg-white">
